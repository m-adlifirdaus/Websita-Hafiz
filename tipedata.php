        ...
        <div class="Container-Navbar">
            <div class="Navbar-Wrapper">
                ...
                <ul class="ul-Navbar-Right">
                    ...
                    <li class="li-Navbar-Right">
                        <a href="tipedata.php" class="a-Navbar" style="font-weight: bold; border-bottom: 3px solid rgb(32, 102, 22); padding-bottom: 5px;">Tipe Data</a>
                    </li>
                    <li class="li-Navbar-Right">
                        <a href="operator.php" class="a-Navbar">Soal</a>
                    </li>
                </ul>
            </div>
        </div>
        <!-- NAVIGATION BAR END -->
         ...
         <!-- NAME OF CONTENT -->
            ...
            <div class="container-fluid px-0">
                <h1 class="h1-php">BELAJAR TIPE DATA PHP</h1>
                <h2 class="h1-php">by AHMAD HAFIZ</h2>
                <h2 class="h1-php">XI-4</h2>


                <h2 class="h2-php">1. Tipe Data String & Integer</h2>
                <div class="output">
                    <?php
                    $nama = "hafiz";     
                    $umur = 17;                
                    ...
                    echo "<p>Nama saya adalah <strong>$nama</strong>, warna yang disukai adalah <strong>$warna</strong>.</p>";
                    echo "<p>Ini adalah contoh <strong>tipe data string</strong>.</p>";
                    echo "<p>Umur saya adalah <strong>$umur</strong>. Ini adalah <strong>tipe data integer</strong>.</p>";
                    ?>
                </div>

                <h2 class="h2-php">2. Tipe Data Float & Operasi Aritmatika</h2>
                <div class="output">
                    <?php
                    $a = 12.2;
                    $b = 118.98;
                    ...
                    echo "<p>$a × $b = <strong>$perkalian</strong></p>";
                    echo "<p>$a − $b = <strong>$kurang</strong></p>";
                    echo "<p>$a + $b = <strong>$tambah</strong></p>";
                    ?>
                </div>

                <h2 class="h2-php">3. Tipe Data Boolean</h2>
                <div class="output" style="margin-bottom: 20px;">
                    <?php
                    $benar = true;
                    $salah = false;

                    echo "<p>Boolean true: <strong>" . var_export($benar, true) . "</strong></p>";
                    echo "<p>Boolean false: <strong>" . var_export($salah, true) . "</strong></p>";
                    ?>
                </div>
                <a href="index.html" class="btn-link" style="margin-bottom: 20px;">Back</a>
            </div>    
            </a>
         </div>
